...
Compared to wikis, the controversy card format is more story-based, more focused on the passing on extraordinary critique, more graphical, and also more useful for sharing content to social media.  The site would moderate the creation of controversy cards, but wikis would be open to everybody.  And since the site's schema enables people to create conflicting wikis in different areas of the site, the point of contention between these two groups could be directed towards the actual debate, away from the petty, endless and pointless ideological war between maverick against-the-mainstream theory-makers and die-hard establishment science apologists.
